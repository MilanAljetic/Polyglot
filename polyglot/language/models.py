...
class User_profile(models.Model):
    ...
    language_nativ = models.ForeignKey(
        Language_nativ, on_delete=models.CASCADE, null=True)
    language_learn = models.ForeignKey(
        Language_learn, on_delete=models.CASCADE, null=True)
...
class Group(models.Model):
    author = models.ForeignKey(
        User_profile, on_delete=models.CASCADE, null=True)
    name = models.CharField(max_length=50, unique=True)
    users = models.ManyToManyField(
        User_profile, null=True, related_name='names')
...
class Rate(models.Model):
    ...
    rate = models.PositiveIntegerField(
        choices=RATE_USER, blank=True, null=True)
